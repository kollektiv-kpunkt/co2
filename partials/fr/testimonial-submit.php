...
if($stmt->execute()) {
    header("location: /wp-content/themes/co2/partials/fr/emails.php?fname={$fname}&lname={$lname}&to={$email}&email=testimonial&origin={$origin}&uuid={$uuid}&quote={$urlquote}");
} else {
